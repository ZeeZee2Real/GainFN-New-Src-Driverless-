...
int main(int argc, const char* argv[])
{
	...
	*/
	...
	system("cls");
	printf("\n");
	printf("       GainFN Verison 2.0 release\n");
	...
	case 2:
		system(("cls"));
		//																								 ADD YOUR OWN DRIVERS OR USE LOLTF ONES THIS IS OLD 
		...
		Beep(560, 500);
		system("cls");
		MessageBoxA(NULL, "GainFN", "Loaded ", MB_OK);
		goto menu_;
		break;
	...
	printf("[ GainFN ] Fortnites Id Base Is: %p", (void*)base_address);
	xCreateWindow();
	Inittt();
	xInitD3d();
...
void xCreateWindow()
{
	...
	Window = CreateWindow("GainFN v2.0 [INSERT]",
		NULL,
		WS_POPUP,
		0,
		0,
...
void render() {
	...
	if (ShowMenu)
	{
		...
		ImGui::Text("GainFN v2.0 [INSERT FOR YOU FAGGOTS]!");
		ImGui::SameLine();
